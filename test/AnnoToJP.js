...
test('GetBorderInfoFromEra', t => {
    ...
    t.deepEqual(GetBorderInfoFromEra('平成'),  { begin: { year: 1989, month: 1, day: 8 }, end: { year: 2019, month: 4, day: 30 }});
});

test('GetJapaneseCalendar', t => {
    t.deepEqual(GetJapaneseCalendar(20190430), { era: { long: '平成', short: '平', alphabet: 'H' }, calendar: { year: 31, month: 4, day: 30 } })
